...
**Plans**: 2 plans
Plans:
- [x] 01-01-PLAN.md — 建立 GlobalStyle、项目 styleAssetId、schema parity 测试和阻塞 Prisma db push。
- [x] 01-02-PLAN.md — 建立 legacy 系统风格投影、统一 resolver、任务快照契约和 focused unit tests。
**UI hint**: no
