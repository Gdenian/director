      ...
      >
        ...
        <div className="glass-surface-modal rounded-2xl p-6 space-y-5">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div
                ...
                style={{ background: 'linear-gradient(135deg, rgba(250,204,21,0.18), rgba(168,85,247,0.18))' }}
              >
                <AppIcon name="sparklesAlt" className="w-5 h-5 text-[#f59e0b]" />
              </div>
              <div>
          ...
          <div
            ...
            style={{ background: 'linear-gradient(135deg, rgba(250,204,21,0.08), rgba(168,85,247,0.08))' }}
          >
            {t('hint')}
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              style={{ background: 'linear-gradient(135deg, #facc15, #a855f7)' }}
            >
