...
export function useNovelPromotionWorkspaceController({
  ...
  const stageRuntime = useWorkspaceStageRuntime({
    ...
    styleAssetId: projectSnapshot.styleAssetId,
    styleSnapshotName: projectSnapshot.styleSnapshotName,
    styleSnapshotStaleMessage: projectSnapshot.styleSnapshotStaleMessage,
