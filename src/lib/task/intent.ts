...
const TASK_INTENT_BY_TYPE: Record<TaskType, TaskIntent> = {
  ...
  [TASK_TYPE.CONSISTENCY_EXPERIMENT_PREPARE]: 'generate',
  [TASK_TYPE.CONSISTENCY_EXPERIMENT_FLOOR_PLAN_IMAGE]: 'generate',
  [TASK_TYPE.CONSISTENCY_EXPERIMENT_GRID_ANALYZE]: 'analyze',
