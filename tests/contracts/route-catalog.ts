...
const ROUTE_FILES = [
  ...
  'src/app/api/asset-hub/styles/[styleId]/default/route.ts',
  ...
  'src/app/api/novel-promotion/[projectId]/editor/media/route.ts',
  'src/app/api/novel-promotion/[projectId]/editor/refine/apply/route.ts',
  'src/app/api/novel-promotion/[projectId]/editor/refine/discard/route.ts',
